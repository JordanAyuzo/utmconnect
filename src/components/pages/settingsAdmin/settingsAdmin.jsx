                        ...
                        <CardContent className="space-y-4">
                            <div className="grid grid-cols-3 items-start gap-6">
                                <div className="space-y-2">
                                    ...
                                    <Input value={userData.name} id="name" readOnly/>
                                </div>
                                <div className="space-y-2">
                                    <Label htmlFor="paternalName">Apellido paterno</Label>
                                    <Input value={userData.paternalName} id="paternalName" readOnly/>
                                </div>
                                <div className="space-y-2">
                                    <Label htmlFor="maternalName">Apellido materno</Label>
                                    <Input value={userData.maternalName} id="maternalName" readOnly/>
                                </div>
                            </div>
                            <div className="grid grid-cols-2 items-start gap-6">
                                <div className="space-y-2">
                                    <Label htmlFor="userNumber">Número de trabajador</Label>
                                    <Input value={userData.userNumber} id="userNumber" readOnly/>
                                </div>
                                <div className="space-y-2">
